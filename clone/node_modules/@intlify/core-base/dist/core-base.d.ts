...
export declare const CORE_WARN_CODES_EXTEND_POINT: number;
...
declare function createDevToolsHook(hook: IntlifyDevToolsHooks): (payloads: IntlifyDevToolsHookPayloads[IntlifyDevToolsHooks]) => void | null;
...
export declare function getLocaleMessage<Context extends CoreContext, Locales = keyof Context['messages'], Return = Context['messages'][keyof Context['messages']]>(ctx: Context, locale: Locales): Return | undefined;
...
export declare function setLocaleMessage<Context extends CoreContext, Locales = keyof Context['messages']>(ctx: Context, locale: Locales, messages: Context['messages'][keyof Context['messages']]): void;
...
export declare const translateDevTools: ReturnType<typeof createDevToolsHook>;
